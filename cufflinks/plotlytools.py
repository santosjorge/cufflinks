		...
		if categories and kind not in ('violin'):
			...
			if kind in ('scatter','spread','ratio','bar','barh','area','line'):
				...
				if y and secondary_y:
					if isinstance(y, str) and isinstance(secondary_y, str):
						cols = [y] + [secondary_y]
					elif isinstance(y, str) and isinstance(secondary_y, list):
						cols = [y] + secondary_y
					elif isinstance(y, list) and isinstance(secondary_y, str):
						cols = y + [secondary_y]
					else:
						cols = y + secondary_y
					df=df[cols]
